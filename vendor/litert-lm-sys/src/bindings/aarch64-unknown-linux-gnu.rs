// Updated to v0.13.1 API (matching x86_64-unknown-linux-gnu.rs).
// v0.13.1 added LiteRtLmConversationOptionalArgs and inserted it as the 4th
// param of send_message and send_message_stream.
