// AUTOGENERATED: copied from x86_64-pc-windows-msvc.rs — same C ABI, different Rust toolchain.
// The v0.13.1 C API changed litert_lm_conversation_config_create to a
// no-arg factory + setters, and added optional_args to send_message_stream.
...
extern "C" {
    // v0.13.1: no-arg factory; use litert_lm_conversation_config_set_* to configure.
...
extern "C" {
    pub fn litert_lm_conversation_send_message(
        ...
        // v0.13.1 added optional_args as 4th param; pass null to use defaults.
...
extern "C" {
    // v0.13.1 inserted optional_args before callback; old bindings had only 5 params
    // which caused &state (callback_data) to land in the callback slot → SIGSEGV.
...
extern "C" {
    pub fn litert_lm_conversation_optional_args_create(
    ) -> *mut LiteRtLmConversationOptionalArgs;
}
extern "C" {
    pub fn litert_lm_conversation_optional_args_delete(
        args: *mut LiteRtLmConversationOptionalArgs,
    );
}
extern "C" {
